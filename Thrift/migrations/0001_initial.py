# Generated by Django 5.1.7 on 2025-03-20 07:37
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('customer', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='Thrift.customer')),
            ],
        ),
        migrations.CreateModel(
            name='Order',
            fields=[
                ...
                ('cart', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='Thrift.cart')),
            ],
        ),
        migrations.CreateModel(
            name='Product',
            fields=[
                ...
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Thrift.category')),
            ],
        ),
        migrations.CreateModel(
            name='CartProduct',
            fields=[
                ...
                ('subtotal', models.PositiveIntegerField()),
                ('cart', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Thrift.cart')),
